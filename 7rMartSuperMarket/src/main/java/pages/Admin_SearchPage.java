...
public class Admin_SearchPage
{
	...
	//@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/list-admin' and @class='small-box-footer']") WebElement adminusermoreinfolink; // added this web element on the page class- Homepage
   ...
   /* public void is_user_able_to_click_admin_user_link()
    ...
    public Admin_SearchPage is_user_able_to_click_adminsearchButton()
    {
    	adminsearch.click();
    	return this;
    }
    public Admin_SearchPage is_user_able_to_enter_the_user_name(String serach_username_field)
    {
    	admin_search_username.sendKeys(serach_username_field);
    	return this;
    }
    public Admin_SearchPage is_user_able_to_select_the_user_type(String searchusertype)
    {
    ...
    public Admin_SearchPage is_user_able_to_click_the_search_button()
    {
    	searchadminresult.click();
    	return this;
    }
    public Admin_SearchPage is_user_able_click_the_resetbutton()
    {
    	admin_reset.click();
    	return this;
    }
